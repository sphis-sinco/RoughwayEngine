...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		else if (SONG.song.toLowerCase() == 'pico' || SONG.song.toLowerCase() == 'blammed' || SONG.song.toLowerCase() == 'philly')
		{
			...
			trainSound = new FlxSound().loadEmbedded('assets/sounds/train_passes' + InitState.soundExt);
		...
		if (isStoryMode)
		{
			switch (curSong.toLowerCase())
			{
				case "winter-horrorland":
					...
					{
						remove(blackScreen);
						FlxG.sound.play('assets/sounds/Lights_Turn_On' + InitState.soundExt);
						camFollow.y = -2050;
						camFollow.x += 200;
						FlxG.camera.focusOn(camFollow.getPosition());
				...
				case 'senpai':
					schoolIntro(doof);
				case 'roses':
					FlxG.sound.play('assets/sounds/ANGRY' + InitState.soundExt);
					schoolIntro(doof);
				case 'thorns':
					schoolIntro(doof);
				default:
					...
					if (SONG.song.toLowerCase() == 'thorns')
					{
						...
						new FlxTimer().start(0.3, function(swagTimer:FlxTimer)
						{
							...
							else
							{
								...
								FlxG.sound.play('assets/sounds/Senpai_Dies' + InitState.soundExt, 1, false, null, true, function()
								{
									remove(senpaiEvil);
									remove(red);
	...
	function startCountdown():Void
	{
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000, function(tmr:FlxTimer)
		{
			...
			{
				case 0:
					FlxG.sound.play('assets/sounds/intro3' + altSuffix + InitState.soundExt, 0.6);
				case 1:
					...
					FlxG.sound.play('assets/sounds/intro2' + altSuffix + InitState.soundExt, 0.6);
				case 2:
					...
					FlxG.sound.play('assets/sounds/intro1' + altSuffix + InitState.soundExt, 0.6);
				case 3:
					...
					FlxG.sound.play('assets/sounds/introGo' + altSuffix + InitState.soundExt, 0.6);
				case 4:
			}
	...
	function endSong():Void
	{
		...
		if (isStoryMode)
		{
			...
			{
				FlxG.sound.playMusic('assets/music/freakyMenu' + InitState.soundExt);
			...
			else
			{
				...
				if (SONG.song.toLowerCase() == 'eggnog')
				{
					...
					FlxG.sound.play('assets/sounds/Lights_Shut_off' + InitState.soundExt);
				}
	...
	function noteMiss(direction:Int = 1):Void
	{
		if (!boyfriend.stunned)
		{
			...
			FlxG.sound.play('assets/sounds/missnote' + FlxG.random.int(1, 3) + InitState.soundExt, FlxG.random.float(0.1, 0.2));
			// FlxG.sound.play('assets/sounds/missnote1' + InitState.soundExt, 1, false);
	...
	{
		FlxG.sound.play('assets/sounds/carPass' + FlxG.random.int(0, 1) + InitState.soundExt, 0.7);
	...
	{
		FlxG.sound.play('assets/sounds/thunder_' + FlxG.random.int(1, 2) + InitState.soundExt);
