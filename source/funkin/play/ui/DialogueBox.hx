...
class DialogueBox extends FlxSpriteGroup
{
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>)
	{
		...
		switch (PlayState.SONG.song.toLowerCase())
		{
			...
			case 'roses':
				FlxG.sound.play('assets/sounds/ANGRY_TEXT_BOX' + InitState.soundExt);
		...
		swagDialogue.sounds = [FlxG.sound.load('assets/sounds/pixelText' + InitState.soundExt, 0.6)];
		add(swagDialogue);
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.ANY  && dialogueStarted == true)
		{
			...
			FlxG.sound.play('assets/sounds/clickText' + InitState.soundExt, 0.8);
