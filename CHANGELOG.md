...
## [0.2.8] - 2025-09-17
### Added
- Support for multiple paths of song audio files: `assets/songs/song/song_songFile`, `assets/songs/song/songFile`, and `assets/songs/song_songFile`
- `songs` folder
### Removed
- Weeks 2 - 6
### Changed
- The freeplay songlist is softcoded now via the week JSON files
- Story mode weeks are softcoded now via JSON files
- Code updated to support updated libraries
